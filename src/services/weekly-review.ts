...
Sua missão é revisar conversas de um atendimento virtual chamado FLORA, que trabalha para o Studio Mariana Castro (studio de unhas em Curitiba/PR).
...
function buildWhatsAppReport(
  ...
  messages.push(`Revisão semanal da FLORA — semana de ${weekStart}`);
